...
*/
func (a *StatisticsApiService) StatisticsUserProfileGet(ctx context.Context) (UserProfileStatisticsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue UserProfileStatisticsResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/statistics/user-profile"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v UserProfileStatisticsResponse
